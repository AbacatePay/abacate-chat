...
export default function Page() {
  ...
  return (
    ...
    <div className="bg-background w-full h-screen flex flex-col justify-center items-center overflow-hidden relative">
       <ThemeToggle />  
      <Image src="/logo.svg" alt="Abacate Logo" height={250} width={250} className="md:h-[500px] md:w-[500px] absolute hidden md:block opacity-30 md:opacity-40 md:bottom-2 md:right-3 md:translate-x-1/2 md:translate-y-1/3 md:top-auto md:left-auto md:rotate-0 md:scale-x-[1] -z-1"  />
